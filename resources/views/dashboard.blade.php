...
<x-app-layout>
    ...
    <div class="py-8 md:py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            <h3 class="text-2xl md:text-3xl font-bold mb-2">Bienvenue, {{ Auth::user()->name }} !</h3>
                            <p class="text-gray-600 text-sm md:text-base">{{ now()->locale('fr')->isoFormat('dddd, D MMMM YYYY') }}</p>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-2 justify-end items-center">
                            @foreach(Auth::user()->getRoleNames() as $role)
                                ...
                                @endphp
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs md:text-sm font-medium {{ $config['bg'] }} {{ $config['text'] }}">
                                    {{ $config['label'] }}
                                </span>
                            @endforeach
                        </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="text-xl md:text-2xl font-semibold text-gray-900">{{ Auth::user()->forms()->count() }}</p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="text-xl md:text-2xl font-semibold text-gray-900">{{ Auth::user()->cdcs()->count() }}</p>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="text-xl md:text-2xl font-semibold text-gray-900">{{ Auth::user()->forms()->where('is_active', true)->count() }}</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                <a href="{{ route('forms.index') }}" aria-label="Forms" class="group">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1">
                        <div class="p-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h4 class="text-lg md:text-xl font-semibold text-gray-900 group-hover:text-green-600">
                                        Formulaires
                                    </h4>
                                ...
                                <svg class="h-5 w-5 md:h-6 md:w-6 text-gray-400 group-hover:text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('profile.edit') }}" aria-label="Profile" class="group">
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1">
                            <div class="p-6">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h4 class="text-lg md:text-xl font-semibold text-gray-900 group-hover:text-indigo-600">
                                            Mon Profil
                                        </h4>
                                        <p class="mt-1 text-sm text-gray-600">
                                    ...
                                    <svg class="h-5 w-5 md:h-6 md:w-6 text-gray-400 group-hover:text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                                </div>
                            </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg md:text-xl font-semibold text-gray-900">Mes derniers formulaires</h3>
                        ...
                        <div class="space-y-3">
                            @foreach($recentForms as $form)
                                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                                    <div class="flex-1">
            ...
            @else
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-12 text-center">
                        ...
                        <h3 class="mt-2 text-sm md:text-base font-medium text-gray-900">Aucun formulaire</h3>
                        <p class="mt-1 text-sm text-gray-500">Commencez par créer votre premier formulaire.</p>
                        <div class="mt-6">
                            <a href="{{ route('forms.create') }}"
                               class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700"
                               aria-label="Create first form">

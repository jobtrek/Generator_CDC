                        ...
                        <div class="border-t pt-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4" data-role-cards>
                                @foreach($roles as $role)
                                    ...
                                    @endphp
                                    <label for="role_{{ $role->id }}" data-role-card class="relative flex items-start py-3 px-4 border rounded-lg hover:bg-gray-50 cursor-pointer transition {{ $activeClass }}">
                                        ...
                                        <div class="ml-3 flex items-center h-5">
                                            <input id="role_{{ $role->id }}" name="role" type="radio" value="{{ $role->name }}" {{ $isChecked ? 'checked' : '' }} required class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                        </div>
                                    </label>
                                @endforeach
                            </div>

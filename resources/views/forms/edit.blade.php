<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center">
            <a href="{{ route('forms.show', $form) }}" class="mr-4 text-gray-600 hover:text-gray-900 transition">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
            </a>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Modifier le CDC : {{ $form->name }}
            </h2>
        </div>
    </x-slot>
    ...
    @php
        ...
        $val = function($key) use ($cdcData) { return old($key, $cdcData[$key] ?? ''); };
        $totalHeures = old('nombre_heures', $cdcData['nombre_heures'] ?? 90);
    @endphp

    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            @if(session('success'))
                <div x-data="{ show: true }" x-show="show" class="mb-4 p-4 bg-green-100 border-l-4 border-green-500 text-green-700 rounded flex items-center justify-between">
            ...
            <form method="POST" action="{{ route('forms.update', $form) }}" class="space-y-6">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="candidat_nom" required value="{{ $val('candidat_nom') }}"
                                       placeholder="Dupont"
                                       class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Prénom du candidat *</label>
                                <input type="text" name="candidat_prenom" required value="{{ $val('candidat_prenom') }}"
                                       placeholder="Jean"
                                       class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="lieu_travail" required value="{{ $val('lieu_travail') }}"
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center">
                                    <input type="radio" name="orientation" value="88601 Développement d'applications"
                                           {{ $val('orientation') == '88601 Développement d\'applications' ? 'checked' : '' }}
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="orientation" value="88602 Informatique d'entreprise"
                                           {{ $val('orientation') == '88602 Informatique d\'entreprise' ? 'checked' : '' }}
                                           class="text-indigo-600">
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="orientation" value="88603 Technique des systèmes"
                                           {{ $val('orientation') == '88603 Technique des systèmes' ? 'checked' : '' }}
                                           class="text-indigo-600">
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="orientation" value="88614 Informaticienne d'entreprise CFC"
                                           {{ $val('orientation') == '88614 Informaticienne d\'entreprise CFC' ? 'checked' : '' }}
                                           class="text-indigo-600">
                        ...
                        <div class="border-t pt-4 mt-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="chef_projet_nom" required value="{{ $val('chef_projet_nom') }}"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Prénom *</label>
                                    <input type="text" name="chef_projet_prenom" required value="{{ $val('chef_projet_prenom') }}"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Email *</label>
                                    <input type="email" name="chef_projet_email" required value="{{ $val('chef_projet_email') }}"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Téléphone *</label>
                                    <input type="tel" name="chef_projet_telephone" required
                                           value="{{ $val('chef_projet_telephone') }}"
                        ...
                        <div class="border-t pt-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Nom *</label>
                                    <input type="text" name="expert1_nom" required value="{{ $val('expert1_nom') }}"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Prénom *</label>
                                    <input type="text" name="expert1_prenom" required value="{{ $val('expert1_prenom') }}"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Email *</label>
                                    <input type="email" name="expert1_email" required value="{{ $val('expert1_email') }}"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Téléphone *</label>
                                    <input type="tel" name="expert1_telephone" required
                                           value="{{ $val('expert1_telephone') }}"
                                           @input="formatSwissPhone($event)"
                                           maxlength="16"
                                           placeholder="+41 79 123 45 67"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="border-t pt-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Nom *</label>
                                    <input type="text" name="expert2_nom" required value="{{ $val('expert2_nom') }}"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Prénom *</label>
                                    <input type="text" name="expert2_prenom" required value="{{ $val('expert2_prenom') }}"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Email *</label>
                                    <input type="email" name="expert2_email" required value="{{ $val('expert2_email') }}"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Téléphone *</label>
                                    <input type="tel" name="expert2_telephone" required
                                           value="{{ $val('expert2_telephone') }}"
                                           @input="formatSwissPhone($event)"
                                           maxlength="16"
                                           placeholder="+41 79 123 45 67"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <input type="time" name="heure_aprem_debut" required
                                               value="{{ $val('heure_aprem_debut') }}"
                                               class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                        <input type="time" name="heure_aprem_fin" required
                                               value="{{ $val('heure_aprem_fin') }}"
                                               class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                    </div>
                                </div>
                            </div>
                        ...
                        {{-- CALCULATEUR DE PLANNING EDIT --}}
                        <div class="border-t pt-6 mt-6 bg-gray-50 p-4 rounded-lg border border-gray-200"
                             x-data="planningCalculatorEdit()"
                             @update-total-edit.window="updateRef($event.detail.value)">
                            ...
                            <div class="flex justify-between items-center mb-6">
                                ...
                                <div class="inline-flex bg-white rounded-lg p-1 border border-gray-300 shadow-sm">
                                    <button type="button" @click="setMode('heures')" :class="mode === 'heures' ? 'bg-indigo-600 text-white shadow' : 'text-gray-600 hover:bg-gray-50'" class="px-4 py-1.5 text-xs font-medium rounded-md transition">Heures</button>
                                    <button type="button" @click="setMode('pourcentage')" :class="mode === 'pourcentage' ? 'bg-indigo-600 text-white shadow' : 'text-gray-600 hover:bg-gray-50'" class="px-4 py-1.5 text-xs font-medium rounded-md transition">Pourcentage</button>
                                </div>
                            </div>
                ...
                <div class="bg-white shadow-sm rounded-lg">
                    ...
                    <div class="p-6">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Description de la procédure</label>
                        <textarea name="procedure" rows="15"
                                  placeholder="Points de la procédure (un par ligne)"
                                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">{{ $val('procedure') }}</textarea>
                ...
                <div class="bg-white shadow-sm rounded-lg">
                    ...
                    <div class="p-6">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Matériel et logiciels (un par ligne)</label>
                        <textarea name="materiel_logiciel" rows="6"
                                  placeholder="1 PC en configuration standard&#10;Environnement de développement Visual Studio"
                                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ $val('materiel_logiciel') }}</textarea>
                ...
                <div class="bg-white shadow-sm rounded-lg">
                    ...
                    <div class="p-6">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Prérequis (un par ligne)</label>
                        <textarea name="prerequis" rows="4"
                                  ...
                                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ $val('prerequis') }}</textarea>
                    </div>
                </div>
                ...
                <div class="bg-white shadow-sm rounded-lg">
                    ...
                    <div class="p-6">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Livrables attendus (un par ligne)</label>
                        <textarea name="livrables" rows="6"
                                  placeholder="Rapport de projet&#10;Journal de travail&#10;Code source complet"
                                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ $val('livrables') }}</textarea>
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-4">
                    <a href="{{ route('forms.show', $form) }}"
                       class="px-6 py-3 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 transition font-medium">
                        Annuler
                    </a>
                    <button type="submit"
    ...
    <script>
        function formatSwissPhone(e) {
            ...
            if (val.length > 0) {
                if (val.startsWith('0')) val = '41' + val.substring(1);
                else if (!val.startsWith('41')) val = '41' + val;
            }
        ...
        function planningCalculatorEdit() {
            const parseValue = (val, def) => {
                if (!val) return def;
                return parseInt(String(val).replace(/[H%]/g, '').trim()) || def;
            };

            const oldAnalyse = "{{ $cdcData['planning_analyse'] ?? '15H' }}";
            const initialMode = oldAnalyse.includes('%') ? 'pourcentage' : 'heures';

            return {
                mode: initialMode,
                totalRef: {{ $totalHeures }},
                analyse: parseValue("{{ $cdcData['planning_analyse'] ?? '' }}", 15),
                implementation: parseValue("{{ $cdcData['planning_implementation'] ?? '' }}", 45),
                tests: parseValue("{{ $cdcData['planning_tests'] ?? '' }}", 20),
                documentation: parseValue("{{ $cdcData['planning_documentation'] ?? '' }}", 10),

                init() {
                    const input = document.getElementById('totalHoursEditInput');
                ...
                get unit() { return this.mode === 'heures' ? 'h' : '%'; },
                get isOver() { return this.mode === 'heures' ? (this.currentSum > this.totalRef) : (this.currentSum > 100); },

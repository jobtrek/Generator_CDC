<div id="section-1" class="bg-white shadow-sm rounded-lg">
    ...
    <div class="p-6 space-y-4">
        ...
        <div>
            ...
            <div class="space-y-2">
                @php $currentOrientation = $getValue('orientation', $orientationDefault ?? ''); @endphp
                @foreach([
        ...
        <!-- Période et horaire -->
        @php
            $jFeriesRaw = old('jours_feries', null);
            $jFeries = $jFeriesRaw !== null
                ? (json_decode($jFeriesRaw, true) ?? [])
        ...
        <div class="border-t pt-4" x-data="planningCalculatorEdit({
            total_heures: '{{ $getValue('nombre_heures', '90') }}',
            planning_analyse: '{{ $getValue('planning_analyse', '15%') }}',
            planning_implementation: '{{ $getValue('planning_implementation', '50%') }}',
            planning_tests: '{{ $getValue('planning_tests', '20%') }}',
            planning_documentation: '{{ $getValue('planning_documentation', '15%') }}'
        })" @init="init()">
...
<div id="section-2" class="bg-white shadow-sm rounded-lg">
    ...
    <div class="p-6">
        <x-markdown-editor name="procedure" :value="$getValue('procedure', $procedureDefault ?? '')" label="Description de la procédure"

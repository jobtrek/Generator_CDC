    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        ...
        <div class="relative w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Réinitialiser le mot de passe</h1>
                <p class="text-gray-600 dark:text-gray-400">Entrez votre adresse email et nous vous enverrons un lien pour réinitialiser votre mot de passe</p>
            </div>
            ...
            <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-slate-800">
                ...
                <div class="relative my-8">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-3 bg-white dark:bg-slate-900 text-gray-600 dark:text-gray-400">Vous avez un compte?</span>
                    </div>
                </div>
